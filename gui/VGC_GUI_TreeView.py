...
class GUI_TreeView(Frame):
    ...
    def init(self):
        ...
        self.item_view.heading('Manual'  , text='Manual'  , anchor="w", command=lambda:self.treeviewSort('Manual', False))
        self.item_view.heading('Other'   , text='Other'   , anchor="w", command=lambda:self.treeviewSort('Other', False))
        self.item_view.heading('Bookmark', text='Bookmark', anchor="w", command=lambda:self.treeviewSort('Bookmark', False))
        self.item_view.heading('Finished', text='Finished', anchor="w", command=lambda:self.treeviewSort('Finished', False))
        self.item_view.heading('Notes'   , text='Notes'   , anchor="w", command=lambda:self.treeviewSort('Notes', False))
