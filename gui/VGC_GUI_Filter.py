...
class GUI_Filter(Frame):
    ...
    def init(self):
        ...
        self.filterInputs["platforms_select"]       = Button(self, width=25, text="Select", relief="groove", command=self.selectPlatforms, bg="white")
        self.filterInputs["platformHolders_txt"]    = Label_(self, width=25, text="Platform holders")
        self.filterInputs["platformHolders_select"] = Button(self, width=25, text="Select", relief="groove", command=self.selectPlatformHolders, bg="white")
        self.filterInputs["regions_txt"]            = Label_(self, width=25, text="Regions")
        self.filterInputs["regions_select"]         = Button(self, width=25, text="Select", relief="groove", command=self.selectRegions, bg="white")
    ...
    def selectPlatforms(self):
        self.platformSelect.show(self.collectionData.platforms_all.items(), self.multiFilter["platforms"], "platforms")
    ...
    def selectPlatformHolders(self):
        self.platformHolderSelect.show(self.collectionData.platformHolders_all.items(), self.multiFilter["platformHolders"], "platform holders")
    ...
    def selectRegions(self):
        self.regionSelect.show( self.collectionData.regions_all.items(), self.multiFilter["regions"], "regions")
