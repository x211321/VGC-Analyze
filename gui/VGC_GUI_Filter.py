...
def initFilter(gui):
    ...
    gui.filterInputs["platformHolder_txt"] = Label_(gui.filter_frame, width=25, text="Platform holder")
    gui.filterInputs["platformHolder"]     = Combobox_(gui.filter_frame, width=27)
    ...
    gui.filterInputs["dateStart_txt"]      = Label_(gui.filter_frame, width=25, text="Min. purchase date")
    gui.filterInputs["dateStart"]          = Entry_(gui.filter_frame, width=30)
    gui.filterInputs["dateEnd_txt"]        = Label_(gui.filter_frame, width=25, text="Max. purchase date")
    gui.filterInputs["dateEnd"]            = Entry_(gui.filter_frame, width=30)
    gui.filterInputs["priceStart_txt"]     = Label_(gui.filter_frame, width=25, text="Min. purchase price")
